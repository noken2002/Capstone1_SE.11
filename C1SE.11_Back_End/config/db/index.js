...
//const MSSQLpool = new mssql.ConnectionPool('Driver={ODBC Driver 17 for SQL Server};Server=MSSQLSERVER01;Database=expressTickets;Trusted_Connection=yes;');

const MSSQLpool = new mssql.ConnectionPool({
    connectionString: 'Driver={ODBC Driver 17 for SQL Server};Server=MSSQLSERVER01\\SQLEXPRESS;Database=expressTickets;Trusted_Connection=yes;',
});
