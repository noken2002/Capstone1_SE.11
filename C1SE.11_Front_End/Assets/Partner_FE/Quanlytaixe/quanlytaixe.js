...
//lấy dữ liệu cho mục quản lý tài xế
let dataDriver = [];
function printDriver(){//------------>In ra danh sách cách vé
    const apiUrl = `http://localhost:3000/partner/driver/${dataAccount.id}`;
    fetch(apiUrl)
    .then(response => response.json())
    .then(data => {
